import type {  StockEntryItemView } from '../../types';
...
interface EditItemOnEntryModalProps {
    item: StockEntryItemView | undefined;
    closeModal: () => void;
    editItem: (item: StockEntryItemView, itemQuantity: number) => void;
}

export const EditItemOnEntryModal = ({
    item,
    closeModal,
    editItem,
}: EditItemOnEntryModalProps) => {
